...
class Net2(nn.Module):
    def __init__(self):
        ...
        self.conv7 = nn.Conv2d(16, 10, 3) # input=5x5x16 output=3x3x10 | RF=32x32
...
class Net6(nn.Module):
    def __init__(self):
        ...
        self.dp2 =nn.Dropout(0.3)        
        self.conv5 = nn.Conv2d(10, 12, 3, bias=False) # input=7x7x10 output=7x7x16 | RF=30x30
        self.bn5 = nn.BatchNorm2d(12)
        self.avgpool = nn.AdaptiveAvgPool2d((1,1))
        
        self.conv6 = nn.Conv2d(12, 10, 3) # input=7x7x16 output=5x5x10 | RF=32x32
